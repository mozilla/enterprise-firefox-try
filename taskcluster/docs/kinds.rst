...
glean
-----
Tasks that run ``./mach glean`` utilities. The ``probes`` task produces a
static JSON snapshot of the Glean metric, ping and tag definitions of Firefox
Desktop, as a shippable alternative to the probe-scraper API.
