...
enum VibrancyTraceEvent {
  ...
  VT_TOOLBAR_DEALLOC_REMOVE = 21,
  VT_VIEW_REGION_DESTRUCTOR = 22,
  VT_UPDATE_ROOT_CA_ENTER = 23,
  VT_UPDATE_ROOT_CA_EXIT = 24,
  VT_HANDLE_CA_TRANSACTION_ENTER = 25,
  VT_HANDLE_CA_TRANSACTION_EXIT = 26,
  VT_TOOLBAR_INIT_ADD_PIXEL = 27,
  VT_SET_TITLE = 28,
  VT_REFLOW_TITLEBAR = 29,
  VT_UPDATE_TITLEBAR_TRANSPARENCY = 30,
  VT_SET_TITLEBAR_SEPARATOR = 31,
  VT_SET_COLOR_SCHEME = 32,
  VT_SET_COLOR_SCHEME_CHANGED = 33,
  VT_SET_TITLE_VISIBILITY = 34,
  VT_CONTENT_VIEW_WANTS_LAYER = 35,
  VT_SET_OPAQUE = 36,
  VT_HIDE_TITLEBAR_SEPARATOR = 37,
  VT_ORDER_FRONT = 38,
  VT_SET_FRAME = 39,
  VT_FULLSCREEN_BUTTON_ADDED = 40,
  VT_SET_SUPPORTS_FULLSCREEN_TRUE = 41,
  VT_SET_SUPPORTS_FULLSCREEN_FALSE = 42,
  VT_SHOWS_FULLSCREEN_BUTTON = 43,
  VT_UPDATE_BUTTONS = 44,
